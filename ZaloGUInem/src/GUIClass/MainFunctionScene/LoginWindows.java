...
public class LoginWindows implements Initializable{
     ...
     */
    @FXML
    protected void LoginProceed() throws IOException, URISyntaxException {
        AnchorPane mainfucnt = FXMLLoader.load(getClass().getResource("MainFunctionWindows.fxml").toURI().toURL());
